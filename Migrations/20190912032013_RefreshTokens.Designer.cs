...
namespace vue.Migrations
{
    ...
    [Migration("20190912032013_RefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vue.Data.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("vue.Data.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("vue.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("vue.Data.Entities.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("vue.Data.Entities.AppRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("vue.Data.Entities.AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("vue.Data.Entities.Order", b =>
                {
                    b.HasOne("vue.Data.Entities.AppUser", "User")
                        .WithMany("Orders")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.OwnsOne("vue.Data.Entities.Address", "DeliveryAddress", b1 =>
                        {
                            ...
                            b1.HasOne("vue.Data.Entities.Order")
                                .WithOne("DeliveryAddress")
                                .HasForeignKey("vue.Data.Entities.Address", "OrderId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("vue.Data.Entities.OrderItem", b =>
                {
                    b.HasOne("vue.Data.Entities.Order")
                        .WithMany("Items")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("vue.Data.Entities.ProductVariant", "ProductVariant")
                        .WithMany()
